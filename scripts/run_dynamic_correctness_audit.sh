...
./build/apps/query_rebuilt_dana \
  ...
  -filter_path data/multiattr_100k_independent/filters.csv \
  -index_root index/static/multiattr_100k_independent/rebuilt_dana \
  -reordered_data_root data/multiattr_100k_independent/rebuild_snapshot/dana \
